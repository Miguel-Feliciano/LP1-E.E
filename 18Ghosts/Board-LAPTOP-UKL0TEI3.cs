    ...
    public class Board
    {
        ...
        public void PlaceGhost()
        {
            for (int l = 0; l < 5; l++)
            {
                for (int c = 0; c < 5; c++)
                {
                    //randomGhost = new Random(0,1);
                    //randomGhost.Next(0,1);

                    if (board[l,c].Color == Colors.Blue)
                    {
                        board[l,c] = new Player (GhostShape.Smile, "A1", "\u263A");
                    }
                    else if (board[l,c].Color == Colors.Red)
                    {
